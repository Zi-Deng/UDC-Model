...
- NICME v3 did not win best recall-first cost-sensitive tradeoff; winner: AP-CSADA.
- NICME v3 did not win best normalized expected-cost performance; winner: AP-CSADA.
- NICME v3 did not win best expected-cost performance; winner: AP-CSADA.
