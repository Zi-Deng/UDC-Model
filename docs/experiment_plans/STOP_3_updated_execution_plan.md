...
| --- | ---: | ---: | --- |
| `UDC-Model/checkpoints` | 19G | 3.1G | `resnet_run` best/final, `resnet_reg` best/final, best checkpoint per HPO trial |
| `UDC-Model` | 34G | 15G | data, results, source, compact checkpoint set |
