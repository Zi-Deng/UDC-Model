...
- `NICME/checkpoints`: reduced from `19G` to `3.1G`.
- Preserved in `NICME`: `resnet_run/checkpoint-437`, `resnet_run/checkpoint-532`, `resnet_reg/checkpoint-551`, `resnet_reg/checkpoint-570`, and one best checkpoint per visible HPO trial.
